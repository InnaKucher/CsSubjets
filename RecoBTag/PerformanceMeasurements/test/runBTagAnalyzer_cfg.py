...
options.register('outFilename', 'JetTree_fcr_test',
    VarParsing.multiplicity.singleton,
...
process.patJetsPFlow.addJetCorrFactors=cms.bool(False)
process.inclusiveCandidateVertexFinder.tracks=cms.InputTag("particleFlowTmp")
...
#process.patMuonsWithoutTrigger.pfMuonSource=cms.InputTag("particleFlowTmp")
#process.patMuonsWithoutTrigger.useParticleFlow=cms.bool(True)
#process.patMuonsWithoutTrigger.isolationValues=cms.PSet()
#process.patMuonsWithoutTrigger.muonSource=cms.InputTag("")


process.p = cms.Path(    process.offlinePrimaryVertices *process.ak4PFJetSequence_mc *
