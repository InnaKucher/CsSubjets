...
#config.General.requestName = 'forest_Pythia6_Cymbal_qcd50_reRunPu'
#config.General.requestName = 'forest_oldHydjet_mbMode_reRunPu_saveAll_take2'
config.General.requestName = 'btag_CsJets_Pythia6_bJet100_pp502_Hydjet_Cymbal_MB'
...
#config.JobType.inputFiles = ['btagnew_new_pythia6MC.db']
config.section_('Data')
#config.Data.userInputFiles = ['btagnew_new_pythia6MC.db']
...
#config.Site.whitelist =  ['T1_IT_CNAF_Disk']
