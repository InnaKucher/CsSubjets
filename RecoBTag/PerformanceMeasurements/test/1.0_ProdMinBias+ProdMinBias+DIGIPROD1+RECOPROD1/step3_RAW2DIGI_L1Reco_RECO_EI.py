...
# with command line options: step3 --datatier GEN-SIM-RECO,AODSIM --conditions auto:run1_mc -s RAW2DIGI,L1Reco,RECO,EI --eventcontent RECOSIM,AODSIM -n 100 --no_exec --filein file:step2.root --fileout file:step3.root
