...
options.setDefault('outputFile', 'JetTree_qcd_CsSubjets')
...
process.btagana.fillsvTagInfo         = True ## True if you want to store information relative to the svTagInfos, set to Fa\lse if produceJetTrackTree is set to False                                                                                   
process.btagana.produceJetTrackTree   = True ## True if you want to keep info for tracks associated to jets : for commissio\ning studies                                                                                                                 
