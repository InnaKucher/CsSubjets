...
options.setDefault('inputFiles',['file:/eos/cms/store/group/phys_heavyions/ikucher/BanaTest_input/04A04E01-A80D-E611-835A-02163E012AD1.root'])
...
process.btagana.runFatJets            = cms.bool(False)
#process.btagana.Jets                  = cms.InputTag("akCsSoftDrop4PFpatJetsWithBtagging")
process.btagana.Jets                  = cms.InputTag("akCsSoftDrop4PFpatBtaggingJetsPacked")
process.btagana.SubJets               = cms.VInputTag("akCsSoftDrop4PFpatBtaggingJetsPacked")
process.btagana.SubJetLabels          = cms.vstring("SubJets")
#process.btagana.SubJetLabels          = cms.vstring("akCsSoftDrop4PFpatSubjetsWithBtagging")
process.btagana.storeTagVariablesSubJets     = False ## True if you want to keep TagInfo TaggingVariables                           
process.btagana.storeCSVTagVariablesSubJets  = True  ## True if you want to keep CSV TaggingVariables                               
...
process.akCs4PFpatJetsWithBtagging.tagInfoSources=cms.VInputTag(bTagInfos)
process.akCsSoftDrop4PFpatJetsWithBtagging.tagInfoSources=cms.VInputTag(bTagInfos)
...
#process.akCsSoftDrop4PFpatBtaggingJetsPacked.tagInfoSources=cms.VInputTag(bTagInfos)
...
process.btagana.ipTagInfos = cms.string('akCsSoftDrop4PFImpactParameter')
process.btagana.ipTagInfosCTag = cms.string('akCsSoftDrop4PFImpactParameter')
...
#IK: no VertexNegative for subjets?
#process.btagana.svNegTagInfos = cms.string('akCsSoftDrop4PFSecondaryVertexNegative')
#process.btagana.svNegTagInfosCTag = cms.string('akCsSoftDrop4PFSecondaryVertexNegative')
...
process.btagana.svNegTagInfos = cms.string('akCsSoftDrop4PFSecondaryVertexNegative')
process.btagana.svNegTagInfosCTag = cms.string('akCsSoftDrop4PFSecondaryVertexNegative')
process.btagana.svTagInfos = cms.string('akCsSoftDrop4PFSecondaryVertex')
process.btagana.svTagInfosCTag = cms.string('akCsSoftDrop4PFSecondaryVertex')


process.btagana.svComputer=cms.string('combinedSecondaryVertexComputer')

#process.btagana.combinedSVBJetTags = cms.string('akCsSoftDrop4PFCombinedSubjetSecondaryVertexBJetTags')
#process.btagana.combinedSVNegBJetTags = cms.string('akCsSoftDrop4PFNegativeCombinedSecondaryVertexBJetTags')
#process.btagana.combinedSVPosBJetTags = cms.string('akCsSoftDrop4PFPositiveCombinedSecondaryVertexBJetTags')

process.btagana.combinedSVBJetTags = cms.string('akCsSoftDrop4PFCombinedSecondaryVertexBJetTags')
process.btagana.combinedSVNegBJetTags = cms.string('akCsSoftDrop4PFNegativeCombinedSecondaryVertexBJetTags')
process.btagana.combinedSVPosBJetTags = cms.string('akCsSoftDrop4PFPositiveCombinedSecondaryVertexBJetTags')

process.btagana.jetBPBJetTags = cms.string('akCsSoftDrop4PFJetBProbabilityBJetTags')
process.btagana.jetPBJetTags = cms.string('akCsSoftDrop4PFJetProbabilityBJetTags')
process.btagana.simpleSVHighEffBJetTags = cms.string('akCsSoftDrop4PFSimpleSecondaryVertexHighEffBJetTags')
process.btagana.simpleSVHighPurBJetTags = cms.string('akCsSoftDrop4PFSimpleSecondaryVertexHighPurBJetTags')
process.btagana.simpleSVNegHighEffBJetTags = cms.string('akCsSoftDrop4PFNegativeSimpleSecondaryVertexHighEffBJetTags')
process.btagana.simpleSVNegHighPurBJetTags = cms.string('akCsSoftDrop4PFNegativeSimpleSecondaryVertexHighPurBJetTags')
process.btagana.trackCHEBJetTags = cms.string('akCsSoftDrop4PFTrackCountingHighEffBJetTags')
process.btagana.trackCHPBJetTags = cms.string('akCsSoftDrop4PFTrackCountingHighPurBJetTags')
...
#IK: remove for now: scikit learning test

#weight file is in  /afs/cern.ch/work/i/ikucher/kurtRepo/CMSSW_7_5_8_patch3/src/RecoBTag/CSVscikit/python/csvscikitTaggerProducer_cfi.py

##process.akCsSoftDrop4PFCSVscikitSubjetTags = process.pfCSVscikitSubjetTags.clone()
#process.akCsSoftDrop4PFpatSubjetsWithBtagging.discriminatorSources.append(cms.InputTag("akCsSoftDrop4PFCSVscikitSubjetTags"))
#process.akCsSoftDrop4PFCSVscikitSubjetTags.tagInfos=cms.VInputTag(cms.InputTag("akCsSoftDrop4PFSubjetImpactParameterTagInfos"), cms.InputTag("akCsSoftDrop4PFSubjetSecondaryVertexTagInfos"))
#process.CSVscikitTags.weightFile=cms.FileInPath('RecoBTag/PerformanceMeasurements/data/TMVA_weights2.xml')
#process.jetSequences.replace(process.akCsSoftDrop4PFCombinedSubjetSecondaryVertexBJetTags,cms.Sequence(process.akCsSoftDrop4PFCombinedSubjetSecondaryVertexBJetTags+process.akCsSoftDrop4PFCSVscikitSubjetTags))
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('file:inRECOSIM_SubJets.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(15728640),
    fileName = cms.untracked.string('file:inAODSIM_SubJets.root'),
